...
import ua.nure.kn156.slepanska.db.DaoFactoryImpl;
import ua.nure.kn156.slepanska.db.MockDaoFactory;
import ua.nure.kn156.slepanska.db.MockUserDao;
import ua.nure.kn156.slepanska.gui.MainFrame;
import ua.nure.kn156.slepanska.util.Messages;
/**
 * class which contains tests for all implemented method(adding,editing,deleting and details users)
 * @author Valeriia
 *
 */
public class MainFrameTest extends JFCTestCase {
	...
	public void testDetailsUser() {
		try {
			...
			assertEquals("George", firstNameField.getText());
			assertEquals("Bush", lastNameField.getText());
			assertEquals(dateFormat.format(currentDate), dateOfBirthField.getText());
			JButton okButton = (JButton) find(JButton.class, "okButton");
			mockUserDao.expectAndReturn("findAll", users);
			getHelper().enterClickAndLeave(new MouseEventData(this, okButton));
